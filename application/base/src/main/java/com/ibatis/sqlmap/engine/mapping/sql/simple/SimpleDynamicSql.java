...
import com.ibatis.sqlmap.engine.mapping.sql.AbstractSql;
import com.ibatis.sqlmap.engine.mapping.sql.Sql;
import com.ibatis.sqlmap.engine.scope.StatementScope;

public class SimpleDynamicSql extends AbstractSql implements Sql {
	...
	public String getSql(StatementScope statementScope, Object parameterObject) {
		return this.getFormatedSql(processDynamicElements(sqlStatement, parameterObject), statementScope, parameterObject);
	}
