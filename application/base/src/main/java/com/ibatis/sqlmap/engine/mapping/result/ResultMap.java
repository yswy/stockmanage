...
import com.bench.app.stockmanage.base.database.oracle.OracleUtils;
...
public class ResultMap {
	...
	protected Object getPrimitiveResultMappingValue(ResultSet rs, ResultMapping mapping) throws SQLException {
		...
		if (value instanceof java.sql.Clob) {
			return DatabaseUtils.convertClobToString((java.sql.Clob) value);
		} else if (value instanceof java.sql.Blob) {
			return DatabaseUtils.convertBlobToBytes((java.sql.Blob) value);
		} else if (value instanceof TIMESTAMP) {
			return OracleUtils.toDate((TIMESTAMP) value);
		}
		return value;
	}
	...
	protected Object doNullMapping(Object value, ResultMapping mapping) throws SqlMapException {
		if (value == null) {
			...
			if (typeHandler != null) {
				...
				throw new SqlMapException("No type handler could be found to map the property '" + mapping.getPropertyName() + "' to the column '"
